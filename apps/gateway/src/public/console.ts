import { ADVANCED_FEATURE_BRANDS, AGENT_SDK_VERSION } from "@odinn/kernel";
...
export function renderConsoleHtml(version = "development") {
  return `<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
    ...
    <aside class="sidebar" id="console-sidebar" aria-label="Primary navigation">
      ...
      <nav class="nav" aria-label="Console views">
        ...
        <details class="nav-more" open>
          ...
          <button data-view="agents" data-title="Agent SDK" type="button"><span class="icon"><svg class="icon-svg"><use href="#icon-agent"></use></svg></span><span class="nav-label">Agent SDK · Experimental</span></button>
      ...
      <section id="view-config" class="view">
        <div class="page oc-page config-page">
          ...
          <div class="config-actions">
            <div class="row"><span class="muted">Saved to the selected state <code>config.json</code> (default <code>~/.odinn/config.json</code>)</span><span class="muted" id="config-field-count"></span></div>
