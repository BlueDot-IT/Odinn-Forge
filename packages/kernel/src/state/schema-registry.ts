...
export const STATE_SCHEMA_OWNERS: Readonly<Record<StateSurface, StateSchemaOwner>> = Object.freeze({
  ...
  records: { owner: "@odinn/store-sqlite", location: "db/odinn.sqlite:record_events (records.jsonl is legacy import/rollback input)", support: "stable", description: "Transactional typed append-only product records" },
  ...
  sessions: { owner: "@odinn/kernel/sessions", location: "db/odinn.sqlite:record_events:session.*", support: "stable", description: "Sessions and messages" },
  projects: { owner: "@odinn/kernel/projects", location: "db/odinn.sqlite:record_events:project.*", support: "stable", description: "Projects" },
  goals: { owner: "@odinn/kernel/goals", location: "db/odinn.sqlite:record_events:goal.*", support: "stable", description: "Goals" },
  memory: { owner: "@odinn/kernel/memory", location: "db/odinn.sqlite:record_events:memory.*", support: "stable", description: "Memory records" },
  ...
  runtimeDatabase: { owner: "@odinn/store-sqlite", location: "db/odinn.sqlite", support: "stable", description: "Run ledger and indexed product records" }
});
