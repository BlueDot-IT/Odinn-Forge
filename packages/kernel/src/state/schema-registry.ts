...
export const STATE_SCHEMA_OWNERS: Readonly<Record<StateSurface, StateSchemaOwner>> = Object.freeze({
  ...
  channelBindings: { owner: "@odinn/channels", location: "channel-bindings.json", support: "stable", description: "External conversation to local session bindings" },
  channelDedupe: { owner: "@odinn/channels", location: "channel-dedupe.json", support: "stable", description: "Restart-safe external message delivery claims" },
