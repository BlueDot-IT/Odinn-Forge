...
const READ_TOOLS = new Set(["job.healthcheck", "text.echo", "workspace.readText", "workspace.list", "workspace.stat", "workspace.search", "workspace.read", "workspace.diff", "web.search", "web.fetch", "browser.tabs", "browser.open", "browser.snapshot", "browser.recovery.status", "email.accounts", "email.search", "email.read", "email.thread", "calendar.calendars", "calendar.events", "calendar.read", "github.repository", "github.issue", "github.pull-request", "github.checks", "memory.search", "memory.recall", "memory.browse", "memory.open", "memory.curate", "session.list", "session.read", "project.list", "goal.list", "improve.list", "mcp.discover", "skill.catalog", "skill.hydrate"]);
