...
| Execution envelopes, attempts, and cancellation-control tables | **Internal implementation detail** | Schema v4 is active behind the stable task surfaces. Physical table layout remains internal; execution admission, audit correlation, idempotency, and uncertain-outcome behavior remain compatibility obligations. |
