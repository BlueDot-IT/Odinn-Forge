...
test("capability registry is versioned, immutable, and separates process authorities", () => {
  ...
  assert.deepEqual(CAPABILITY_IDS, [
    "workspace.inspect", "workspace.mutate", "workspace.patch", "git.read", "github.read", "node.read", "process.execute",
    "process.interactive", "process.shell", "network.access", "browser.read",
    "browser.mutate", "computer.read", "computer.mutate", "email.read", "calendar.read", "agent.delegate", "mcp.discover", "mcp.invoke",
